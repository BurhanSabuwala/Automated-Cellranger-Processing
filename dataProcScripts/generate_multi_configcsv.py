...
file_path = '/vast/palmer/scratch/kleinstein/bhs27/compendium/SRP314557/Subject2051/srasheet_Subj2051.csv'
df = pd.read_csv(file_path)

# Base directory where the CSV files will be saved
output_dir = '/vast/palmer/scratch/kleinstein/bhs27/compendium/SRP314557/Subject2051/multi_configs'
